...
const MELODIES: Record<string, MelodyNote[][]> = {
  ...
  // Mary Had a Little Lamb (4 行)
  mary: [
    [['E4', 1], ['D4', 1], ['C4', 1], ['D4', 1], ['E4', 1], ['E4', 1], ['E4', 2]],
    [['D4', 1], ['D4', 1], ['D4', 2], ['E4', 1], ['E4', 1], ['E4', 2]],
    [['E4', 1], ['D4', 1], ['C4', 1], ['D4', 1], ['E4', 1], ['E4', 1], ['E4', 2]],
    [['D4', 0.5], ['D4', 0.5], ['D4', 1], ['E4', 1], ['D4', 1], ['C4', 2]],
  ],
  // Old MacDonald Had a Farm (7 行)
  macdonald: [
    [['C4', 1], ['C4', 1], ['C4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2]],
    [['E4', 1], ['E4', 1], ['D4', 1], ['D4', 1], ['C4', 2]],
    [['C4', 0.5], ['C4', 0.5], ['C4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 1], ['G4', 1]],
    [['E4', 1], ['E4', 1], ['D4', 1], ['D4', 1], ['C4', 2]],
    [
      ['G4', 0.5], ['G4', 0.5], ['G4', 1], ['G4', 1], ['C4', 1],
      ['G4', 0.5], ['G4', 0.5], ['G4', 1], ['G4', 1], ['C4', 1],
    ],
    [['C4', 1], ['C4', 1], ['C4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2]],
    [['E4', 1], ['E4', 1], ['D4', 1], ['D4', 1], ['C4', 2]],
  ],
  // The Wheels on the Bus (4 行)
  wheels: [
    [['C4', 0.5], ['C4', 0.5], ['F4', 1], ['F4', 1], ['F4', 1], ['F4', 0.5], ['A4', 0.5], ['A4', 1], ['C5', 1]],
    [['A4', 1], ['A4', 0.5], ['G4', 0.5], ['F4', 1], ['F4', 0.5], ['F4', 0.5]],
    [['C4', 0.5], ['C4', 0.5], ['F4', 1], ['F4', 1], ['F4', 1], ['F4', 0.5], ['A4', 0.5], ['A4', 1], ['C5', 1]],
    [['F4', 1], ['E4', 1], ['D4', 1], ['C4', 2]],
  ],
  // Head, Shoulders, Knees and Toes (4 行)
  head: [
    [['G4', 1], ['G4', 1], ['G4', 1], ['E4', 1], ['C4', 1], ['C4', 2]],
    [['E4', 1], ['D4', 1], ['C4', 2]],
    [['G4', 1], ['G4', 0.5], ['G4', 0.5], ['A4', 1], ['A4', 1], ['G4', 1], ['E4', 1]],
    [['G4', 1], ['G4', 1], ['E4', 1], ['D4', 1], ['D4', 1], ['C4', 2]],
  ],
  // If You Are Happy (8 行)
  happy: [
    [['C4', 0.5], ['C4', 0.5], ['C4', 0.5], ['F4', 1], ['F4', 1], ['F4', 0.5], ['F4', 1], ['A4', 1]],
    [['G4', 1], ['G4', 1], ['C5', 2]],
    [['C4', 0.5], ['C4', 0.5], ['C4', 0.5], ['F4', 1], ['F4', 1], ['F4', 0.5], ['F4', 1], ['A4', 1]],
    [['G4', 1], ['G4', 1], ['C5', 2]],
    [['C4', 0.5], ['C4', 0.5], ['C4', 0.5], ['F4', 1], ['F4', 1], ['F4', 0.5], ['F4', 1], ['A4', 1]],
    [['A4', 0.5], ['A4', 0.5], ['G4', 1], ['G4', 1], ['F4', 1], ['F4', 1], ['E4', 1]],
    [['C4', 0.5], ['C4', 0.5], ['C4', 0.5], ['F4', 1], ['F4', 1], ['F4', 0.5], ['F4', 1], ['A4', 1]],
    [['G4', 1], ['F4', 1], ['C4', 2]],
  ],
  // Hickory Dickory Dock (5 行)
  hickory: [
    [['C4', 0.5], ['C4', 0.5], ['G4', 1], ['G4', 0.5], ['G4', 0.5], ['E4', 1]],
    [['F4', 0.5], ['F4', 0.5], ['A4', 1], ['G4', 1], ['F4', 0.5], ['E4', 1]],
    [['G4', 1], ['G4', 1], ['E4', 1], ['C4', 1]],
    [['F4', 1], ['F4', 1], ['D4', 1], ['C4', 1]],
    [['C4', 0.5], ['C4', 0.5], ['G4', 1], ['G4', 0.5], ['G4', 0.5], ['C4', 2]],
  ],
  // Humpty Dumpty (4 行)
  humpty: [
    [['C4', 1], ['C4', 1], ['E4', 1], ['E4', 1], ['G4', 1], ['G4', 0.5], ['G4', 0.5], ['E4', 2]],
    [['C4', 1], ['C4', 1], ['E4', 1], ['E4', 1], ['G4', 1], ['G4', 0.5], ['G4', 0.5], ['F4', 1], ['D4', 2]],
    [
      ['G4', 0.5], ['G4', 0.5], ['G4', 1], ['A4', 1], ['G4', 1],
      ['F4', 0.5], ['F4', 0.5], ['F4', 1], ['E4', 1], ['D4', 1],
    ],
    [
      ['C4', 0.5], ['C4', 0.5], ['E4', 1], ['G4', 1], ['G4', 1],
      ['F4', 0.5], ['E4', 0.5], ['D4', 1], ['D4', 1], ['C4', 2],
    ],
  ],
  // London Bridge Is Falling Down (4 行)
  bridge: [
  ...
  // Are You Sleeping / Frère Jacques (5 行)
  sleeping: [
  ...
  // BINGO (5 行)
  bingo: [
    [['C4', 0.5], ['C4', 0.5], ['C4', 1], ['G4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 1]],
    [['E4', 1], ['E4', 1], ['D4', 1], ['D4', 1], ['C4', 1], ['C4', 1], ['C4', 2]],
    [
      ['G4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2],
      ['G4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2],
    ],
    [['G4', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2]],
    [['E4', 1], ['E4', 1], ['D4', 1], ['D4', 1], ['C4', 1], ['C4', 1], ['C4', 2]],
